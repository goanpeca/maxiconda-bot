...
# Latest 3.7 PyPy
conda create -n pypy37 mamba pypy3.7
conda activate pypy37
mamba install --file ./maxiconda-bot/requirements.txt --yes
pypy3.7 ./maxiconda-bot/scripts/solve.py

# Latest 3.8 CPython
conda create -n py38 mamba python=3.8
conda activate py38
mamba install --file ./maxiconda-bot/requirements.txt --yes
python ./maxiconda-bot/scripts/solve.py

# Latest 3.9 CPython
conda create -n py39 mamba python=3.9
conda activate py39
mamba install --file ./maxiconda-bot/requirements.txt --yes
python ./maxiconda-bot/scripts/solve.py
